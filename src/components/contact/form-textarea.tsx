  ...
  return (
    <div className="relative">
      <textarea
        id={id}
        placeholder={label}
        className={`peer w-full resize-none rounded-xl border bg-surface px-5 pb-3 pt-6 text-sm text-ink outline-none transition-[border-color,box-shadow] duration-300 ease-out placeholder:text-transparent focus:shadow-[0_0_0_4px_color-mix(in_srgb,var(--color-accent)_14%,transparent)] ${
